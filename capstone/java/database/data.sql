...
INSERT INTO list (group_id, list_title, description, claimed, date_modified) VALUES (1001, 'testList', 'test description', 'o', 'date');
INSERT INTO list_item(date_modified, quantity, last_modifier, list_id, group_id, item_name) VALUES ('change', 10, 1, 2001, 1001, 'cool name for item');
INSERT INTO group_member(user_id, group_id, username, date_joined) VALUES (1, 1001, 'fridgrr member', 'date');
COMMIT TRANSACTION;
