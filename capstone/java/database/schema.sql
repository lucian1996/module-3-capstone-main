...
CREATE SEQUENCE seq_group_id,
	...
	NO MAXVALUE;
CREATE TABLE  groups (
	group_id int NOT NULL DEFUALT nextval('seq_group_id'),
...
CREATE TABLE group_member (
    ...
    CONSTRAINT PK group_member PRIMARY KEY (user_id, group_id),
...
CREATE TABLE list_item (
    ...
    CONSTRAINT quantity chk_quantity CHECK (quantity > 0)
    );
)
